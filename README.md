 <h2 style="text-align: center;">![Banner](https://i.ibb.co/ZM5sbKM/banner.png)</h2>undefined <h1 style="text-align: center;">**Azukaar's Fair Difficulty Overhaul**</h1> <p style="text-align: center;"><span style="color: #e03e2d;"><strong>This mod is safe to include in your modpack/server as it leaves the vanilla difficulties untouched!</strong></span></p> <p style="text-align: center;"> <span style="font-size: 18px;"><strong><iframe src="https://www.youtube.com/embed/23YC5fwj5fY?si=mUFvj8wruUdJY-ZB" width="560" height="315" frameborder="0" allowfullscreen="allowfullscreen"></iframe>&nbsp;</strong></span></p><h2 style="text-align: left;">About</h2><p style="text-align: left;">The goal of **AFDO** is to introduce a new depth to Minecraft's difficulty system. The philosophy of the mod is to not be intrusive, be flexible, and of course, fair. It adds a few new features, such as **the per-player difficulty mechanics** which allows each players on the same server to play on different difficulties, and additional mobs / AI systems to the game, which scale with the difficulty you play.</p> 
...
*   New mobs with new behaviours and lore. Some new mobs can mine or place blocks for example, but only spawn in Expert and above difficulties
*   Configurations to adapt the difficulty to your taste or integrate other mods
...
![Raised Zombie](https://i.ibb.co/sQjF7x0/Layer-4.png)

<p style="text-align: center;">**Raised Zombies (Expert Difficulty and above)**</p> 
...
   <p style="text-align: center;">![](https://i.ibb.co/2vk5D1Y/Layer-5.png)**Ancient Creeper (Expert Difficulty and above)**</p> 
...
*   From expert, hunger is reduced when respawning (can't suicide feed yourself anymore!)
*   The mod introduces a night purge, to improve mob population control. It prevents cave mobs from hoarding the mob slots, preventing the surface mobs from spawning (togglable)
*   The new mobs have different behaviour from the vanilla ones

<p style="padding-left: 30px;">\- Some of them can smell you through wall on short distance</p><p style="padding-left: 30px;">\- Some of them will destroy chest and torches on sight (aka. the one they can actually SEE) so don't leave stuff unintended outside, build a base!</p><p style="padding-left: 30px;">\- Some of them can pick up items and use them</p> 
...
 <h2 style="text-align: left;">The details (mobs)</h2><h3 style="text-align: left;">Raised Zombies</h3> <p style="text-align: left;"> - Only spawn in > expert</p><p style="text-align: left;"> - Stronger than regular zombie</p><p style="text-align: left;"> - If equiped with a tool, they can break block, if equiped with blocks, they'll build stairs/bridges</p><p style="text-align: left;"> - Can smell the player at 6 blocks distance</p><p style="text-align: left;"> **- Will target  unintended chests and torches, if they can see them (so don't** leave **them outside in easy to reach places)**</p> <h3 style="text-align: left;"> **Ancient Creeper**</h3> <p style="text-align: left;"> - Only spawn in > expert</p><p style="text-align: left;"> - Stronger than regular creeper</p><p style="text-align: left;"> - Will target unintended chests if they can see them</p><p style="text-align: left;"> - Charged creeper gets the ability to sense things that are close to them. Once they are angered, they will explode within the next 10sec whether or not they have reach their objectives</p> <h2 style="text-align: left;">The details (difficulties)</h2><h3 style="text-align: left;">Expert</h3> 

 <span style="font-size: 18px;">&nbsp;- Mobs deal 20% more damage than in hard</span>

 <span style="font-size: 18px;">&nbsp;- Mobs have a 20% chance to evolve to new mobs</span>

 <span style="font-size: 18px;">&nbsp;- Mobs have a 10% chance to be promoted (charged creepers, zombies with tools, wither zombies)</span>

 <span style="font-size: 18px;">&nbsp;- Player will respawn with 10 hunger</span>

 <span style="font-size: 18px;">&nbsp;- Player cannot sleep anymore</span>

 

### **<span style="font-size: 18px;">Nightmare</span>**

 

 <span style="font-size: 18px;">&nbsp;- Mobs deal x2 damage compared to hard<br></span>

 <span style="font-size: 18px;">&nbsp;- Mobs have a 35% chance to evolve to new mobs</span>

 <span style="font-size: 18px;">&nbsp;- Mobs have a 15% chance to be promoted (charged creepers, zombies with tools, wither zombies)</span>

 <span style="font-size: 18px;">&nbsp;- Player will respawn with 5 hunger</span>

 <span style="font-size: 18px;">&nbsp;- Player cannot sleep anymore</span>

 

### **<span style="font-size: 18px;">Apocalyptic</span>**

 

 <span style="font-size: 18px;">&nbsp;- Mobs deal x4 damage compared to hard<br></span>

 <span style="font-size: 18px;">&nbsp;- Mobs have a 60% chance to evolve to new mobs</span>

 <span style="font-size: 18px;">&nbsp;- Mobs have a 25% chance to be promoted (charged creepers, zombies with tools, wither zombies)</span>

 <span style="font-size: 18px;">&nbsp;- Player will respawn with 1 hunger</span>
