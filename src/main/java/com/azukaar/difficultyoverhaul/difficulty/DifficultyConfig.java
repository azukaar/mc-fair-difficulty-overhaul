...
public class DifficultyConfig {
    public static class Server {
        ...
        public final ModConfigSpec.ConfigValue<Boolean> peacefulRegen;
        public final ModConfigSpec.ConfigValue<Boolean> peacefulNoFood;
        public final ModConfigSpec.ConfigValue<Boolean> disableCustomTexture;
